...
import com.ubaya.nmp_esports.databinding.FragmentWhoWeAreBinding
...
class WhoWeAreFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        sharedPreferences = requireContext().getSharedPreferences("game_prefs", MODE_PRIVATE)
        ...
        binding.backHomeBtn.setOnClickListener {
            val intent = Intent(requireContext(), PlayFragment::class.java)
