...
object ScheduleData {
    var schedule: Array<Schedule> = arrayOf(
        Schedule("Open Winter Cup - Valorant","19-09-2024 10.00 PM", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
        ...
        Schedule("Open Winter Cup - Mobile Legend","27-09-2024 13.00 PM", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
                ...
                "Donec varius, libero in euismod efficitur, felis risus sagittis leo, " +
                "a commodo tortor quam id justo. Nam sem turpis, consequat eu ultricies vitae, " +
                "vehicula consequat turpis. Donec nec tincidunt ipsum.  ", R.drawable.mobilelegendhorizontal),
        Schedule("Open Winter Cup - Fortnite","09-09-2024 15.00 PM", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
                "Donec purus quam, faucibus ut congue ac, finibus nec magna. " +
                "Sed mollis ipsum sapien. Fusce gravida ipsum ut erat feugiat, in laoreet ex vehicula. " +
                "Nam tempor mi in nibh euismod, vitae vehicula justo elementum. " +
                "Donec dignissim vitae arcu in dictum. Etiam iaculis malesuada tellus sit amet consequat. " +
                ...
                "Donec varius, libero in euismod efficitur, felis risus sagittis leo, " +
                "a commodo tortor quam id justo. Nam sem turpis, consequat eu ultricies vitae, " +
                "vehicula consequat turpis. Donec nec tincidunt ipsum.  ", R.drawable.fortnitelogo)
